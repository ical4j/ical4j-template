...
class RepeatsTest extends Specification {
    ...
    def 'test recurrence creation'() {
        ...
        new Repeats(Days.ONE)                       | 'RRULE:FREQ=DAILY;INTERVAL=1\r\n'
        ...
        new Repeats(Months.of(3))
                .on(1, 15)                         | 'RRULE:FREQ=MONTHLY;INTERVAL=3;BYMONTHDAY=1,15\r\n'
        new Repeats(Years.of(1))
                .on(APRIL, MAY).times(3) | 'RRULE:FREQ=YEARLY;COUNT=3;INTERVAL=1;BYMONTH=4,5\r\n'
    }
}
